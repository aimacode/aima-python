...
neighbors = {
    ...
    'Fukushima': ['Miyagi', 'Yamagata', 'Nigata', 'Gunma', 'Tochigi', 'Ibaraki'],
    ...
    'Saitama': ['Gunma', 'Ibaraki', 'Chiba', 'Tokyo', 'Yamanashi'],
    'Gunma': ['Nigata', 'Nagano', 'Saitama', 'Tochigi'],
