        ...
        for player in players:
            if player == players[0]:
                while state.to_move == 'Player':
                    ...
                    if player.label != 'Ask':
                        # for versing the machine
                        # theTk.update()
                        # time.sleep(2)

                        # for machine vs machine
                    ...
                    if game.terminal_test(state):
                        ...
                        # use this next line to close windows
                        # theTk.destroy()
                        ...
                        # use next line for player vs machine
                        # theTk.mainloop()

                        # use next lines for machine vs machine loop
                        theTk.update()
                        # theTk.destroy()
...
def Diff(difficulty, master, game):
    ...
    master.destroy()
    thing = Tk()
    label0 = Label(thing, text = 'Heuristic 1 first vs Heuristic 4 second')
    ...
    button2 = Button(thing, text='Machine vs Machine', command=lambda: start('Machine', thing, game, depth))
    button2.place(x=45, y=150)
    # button3 = Button(thing, text='Machine Loop x 2', command=lambda: start('Loop50', thing, game, depth))
    # button3.place(x=75, y=240)
    thing.geometry('300x250')
    thing.mainloop()
