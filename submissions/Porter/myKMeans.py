...
setupScales(Frame.data)
billScaled.data = scaleGrid(Frame.data)
billScaled.feature_names = Frame.feature_names
billScaled.target = Frame.target
billScaled.target_names = Frame.target_names
