...
from grid import distance_square, turn_heading
...
class XYEnvironment(Environment):
    ...
    def things_near(self, location, radius=None):
        ...
        return [(thing, radius2 - distance_square(location, thing.location)) for thing in self.things
                if distance_square(location, thing.location) <= radius2]
