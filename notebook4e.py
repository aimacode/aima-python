...
#####################           Animation Class for search problems.            ####################
...
failure = Node('failure', path_cost=np.inf) # Indicates an algorithm couldn't find a solution.
cutoff  = Node('cutoff',  path_cost=np.inf) # Indicates iterative deepening search was cut off.
