...
def test_value_iteration():
    ...
    # tolerance via pytest.approx
    assert value_iteration(sequential_decision_environment, .01) == pytest.approx({
        (3, 2): 1.0, (3, 1): -1.0,
    ...
    assert value_iteration(sequential_decision_environment_1, .01) == pytest.approx({
        (3, 2): 1.0, (3, 1): -1.0,
    ...
    assert value_iteration(sequential_decision_environment_2, .01) == pytest.approx({
        (3, 2): 1.0, (3, 1): -1.0,
    ...
    assert value_iteration(sequential_decision_environment_3, .01) == pytest.approx({
